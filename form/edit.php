...
<body class="flex justify-center items-center h-screen">
  <div>
    ...
    <form class="relative w-[27.5rem]" action="../controller/edit.php" method="POST">
      <input id="nrp" class="form__input" type="number" name="nrp" autocomplete="off" placeholder=" " value="<?= $students["nrp"] ?>" hidden />
      ...
      <div class="relative mb-3 h-[50px]">
        <input class="form__input" id="asal_sekolah" type="text" name="asal_sekolah" autocomplete="off" placeholder=" " value="<?= $students["asal_sekolah"] ?>" required />
